...
<?php 
    if(isset($_POST['submit'])){
       $name = $_POST['name'];
        ...
        $subject ="Email from Website Contact Page. For the Inquiry of: ".$service;
        $message ="My Name is : ".$name. " of Email: ".$email." and Telephone". $phone." The Following is my message: ".$message;
        $headers ="From: ".$email;
